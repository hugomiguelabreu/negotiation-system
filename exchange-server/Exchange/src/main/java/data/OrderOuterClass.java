...
public final class OrderOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public Type getOrderType() {
      Type result = Type.valueOf(orderType_);
      return result == null ? Type.BUY : result;
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (hasSetPrice()) {
        result = result && (
            Double.doubleToLongBits(getSetPrice())
    ...
    public static final class Builder extends
       ...
       * <code>required .order.Order.Type orderType = 1;</code>
       */
      public Builder setOrderType(Type value) {
        if (value == null) {
  ...
  static {
    ...
    internal_static_order_Order_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_order_Order_descriptor,
        new String[] { "OrderType", "Symbol", "Quantity", "SetPrice", "User", });
  }
